...
from .func import xor, rotl, get_uint32_be, put_uint32_be, \
    bytes_to_list, list_to_bytes, padding, unpadding, printArry
...
class Skf(QWidget):
    ...
    def SKF_ECCVerify(self):
        ...
        # HASH = Arr32(0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0a,0x0b,0x0c,0x0d,0x0e,0x0f,
        #              0x10,0x11,0x12,0x13,0x14,0x15,0x16,0x17,0x18,0x19,0x1a,0x1b,0x1c,0x1d,0x1e,0x1f)
        #
        # PUBK = Arr128(0x8d,0x8e,0x07,0x89,0x66,0x5e,0x1e,0xe4,0x20,0xc3,0x37,0xce,0x54,0x2c,0x93,0x08,
        #               0x01,0x8c,0x98,0x5f,0xc3,0x76,0x17,0x4c,0x08,0x98,0xc2,0xec,0x56,0x07,0x1e,0xc1,
        #               0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        #               0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        #               0xba,0xfd,0xc7,0xf4,0x33,0x93,0xc5,0x21,0x11,0x2a,0x77,0x09,0x4b,0x51,0x17,0x1c,
        #               0x89,0x3d,0xee,0xc2,0x16,0x32,0x6b,0xb4,0xaa,0x9b,0x41,0x4f,0x0c,0x9f,0x16,0x76,
        #               0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        #               0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00)
        #
        # g.pSignature = Arr128(0xe4,0xca,0x7d,0x3b,0xa8,0xc2,0xac,0xe8,0xeb,0xd4,0xc2,0x89,0x44,0x69,0x8b,0x8a,
        #                       0xdc,0x80,0x37,0x6c,0x2e,0xe1,0x4d,0xf8,0x7d,0x4e,0x6c,0xa5,0xd9,0xa3,0xba,0xdb,
        #                       0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        #                       0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        #                       0xe9,0xc2,0x9b,0x6c,0x1c,0xbe,0x58,0xc3,0x10,0x44,0x07,0xa4,0x68,0x96,0xf1,0xe4,
        #                       0x9e,0x60,0xcc,0x0b,0x5f,0x7c,0x1e,0xa9,0x57,0x55,0x2c,0x4b,0x23,0x8e,0xa9,0x5f,
        #                       0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
        #                       0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00)
        ...
        printArry("g.pBlob.XCoordinate", g.pBlob.XCoordinate)
        printArry("g.pBlob.YCoordinate", g.pBlob.YCoordinate)
        # memmove(g.pBlob.XCoordinate, PUBK, 64)
        # memmove(g.pBlob.YCoordinate, byref(PUBK, 64), 64)


        Signature = ECCSIGNATUREBLOB()
        memmove(Signature.r, g.pSignature, 64)
        memmove(Signature.s, byref(g.pSignature, 64), 64)
        printArry("g.pSignature",g.pSignature)
